package ru.sberbank.school.comment.configuration;
...
@Configuration
@EntityScan("ru.sberbank.school.comment.entity")
@EnableJpaRepositories("ru.sberbank.school.comment.repository")
